    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situation_en', models.CharField(blank=True, help_text='GPT 프롬프트에 직접적으로 활용됩니다. 비워두시면, situation 필드를 번역해 자동 반영됩니다.', max_length=100, verbose_name='상황 (영문)')),
                ('my_role', models.CharField(max_length=100, verbose_name='내 역할')),
                ('my_role_en', models.CharField(blank=True, help_text='GPT 프롬프트에 직접적으로 활용됩니다. 비워두시면, my_role 필드를 번역해 자동 반영됩니다.', max_length=100, verbose_name='내 역할 (영문)')),
                ('gpt_role', models.CharField(max_length=100, verbose_name='GPT 역할')),
                ('gpt_role_en', models.CharField(blank=True, help_text='GPT 프롬프트에 직접적으로 활용됩니다. 비워두시면, gpt_role 필드를 번역해 자동 반영됩니다.', max_length=100, verbose_name='GPT 역할 (영문)')),
